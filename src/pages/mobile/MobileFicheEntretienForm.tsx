...
import ChecklistSuppliesStep from "@/components/mobile/steps/ChecklistSuppliesStep";
    ...
    switch (step) {
      ...
      case 9: return (
        <InternalStep title="Description & Achats"
          ...
          showDescription description={description} onDescriptionChange={handleChange(setDescription)} />
      );
      default: return null;
    }
  };
